...
class _VenueDetailScreenState extends State<VenueDetailScreen> {
  ...
  Future<void> _onSlotTap(SlotEntity slot) async {
    ...
    if (confirmed == true) await _cubit.bookSlot(slot);
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
      ...
      child: BlocListener<VenueDetailCubit, VenueDetailState>(
        listenWhen: (p, c) => p.bookingFeedback != c.bookingFeedback && c.bookingFeedback != null,
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Text(venue.emoji, style: const TextStyle(fontSize: 32)),
